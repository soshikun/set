...
***
<p>
  <img src="https://courses.cs.washington.edu/courses/cse154/20au/homework/hw2/screenshots/spec-intro-view.png" width="60%" alt="Set! Game board">
</p>
...
## Assignment Overview
In this assignment you will use JS to add functionality to a basic webpage. Specifically,
...
page](https://courses.cs.washington.edu/courses/cse154/20au/homework/hw2/hw2.mp4) of the course website.
...
<p>
  <img src="https://courses.cs.washington.edu/courses/cse154/20au/homework/hw2/screenshots/set-example.png" width="50%" alt="Example of something that is a set">
</p>
...
<p>
  <img src="https://courses.cs.washington.edu/courses/cse154/20au/homework/hw2/screenshots/not-set-example.png" width="50%" alt="Example of something that is not a Set">
</p>
...
program and allow for flexibility if users later want to change the images and attributes, **we require using 4 arrays as module-global constants, one for each attribute type (style, color,
shape, count) - since count is an integer, you may alternatively use a different datatype to represent it as a constant.** Remember that a module-global is any that is in the module pattern but
defined outside of the local scope of functions within the module pattern (in general, you
should minimize the number of module-global _variables_).
...
* Below is an example of the message displayed when an incorrect Set is selected:
  <img src="https://courses.cs.washington.edu/courses/cse154/20au/homework/hw2/screenshots/game-view-not-set.png" width="60%" alt="Not a Set display example">
...
course [academic integrity](https://courses.cs.washington.edu/courses/cse154/20au/syllabus/syllabus.html#academic-conduct)
